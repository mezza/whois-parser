...
describe "whois.fi", :aggregate_failures do
  ...
  it "matches property_status_graceperiod.expected" do
    ...
    expect(subject.registrant_contacts[0].id).to eq("2823344-7")
    expect(subject.registrant_contacts[0].name).to eq("Digiteam Oy")
    expect(subject.registrant_contacts[0].address).to eq("Myllyniityntie 71")
    expect(subject.registrant_contacts[0].city).to eq("Lohja")
    expect(subject.registrant_contacts[0].zip).to eq("08100")
    expect(subject.registrant_contacts[0].state).to eq(nil)
    expect(subject.registrant_contacts[0].country).to eq("Finland")
    expect(subject.registrant_contacts[0].country_code).to eq(nil)
    expect(subject.registrant_contacts[0].phone).to eq("+358.503716096")
